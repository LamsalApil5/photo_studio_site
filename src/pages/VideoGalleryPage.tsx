        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-neutral-300 mb-8">
              Cinematic stories that capture movement, emotion, and special
              moments.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-neutral-700 max-w-3xl mx-auto">
              We offer comprehensive video production solutions for various
              events and purposes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-neutral-50 p-6 rounded-lg">
              ...
              <p className="text-neutral-700">
                ...
                capturing all the emotions and special moments of your big day.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-6 rounded-lg">
              ...
              <p className="text-neutral-700">
                High-quality commercial videos to showcase your products,
                services, or brand story in an engaging and professional way.
              </p>
            </div>
            ...
            <div className="bg-neutral-50 p-6 rounded-lg">
              ...
              <p className="text-neutral-700">
                Comprehensive event coverage for corporate events, conferences,
